# <img src="https://ms-vscode.gallerycdn.vsassets.io/extensions/ms-vscode/cpptools/0.24.1/1563824336931/Microsoft.VisualStudio.Services.Icons.Default" width="48" height="48"/> [C/C++ for Visual Studio Code](https://chocolatey.org/packages/vscode-cpptools)
...
* `cpptools-win32.vsix` - for 64-bit and 32-bit Windows
